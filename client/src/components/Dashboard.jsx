    ...
    const mockData = {
      reported: [
        ...
        { 
          ...
          severity: "Medium", 
          reportedDate: "2025-08-14", 
          reporter: "Jane Smith",
          imageUrl: "https://images.unsplash.com/photo-1616048056616-7c5d50c45ce3?w=500&h=300&fit=crop",
          description: "Medium-sized pothole near parking area",
          coordinates: "40.7589° N, 73.9851° W",
          mapUrl: "https://www.google.com/maps?q=40.7589,-73.9851"
        },
        { 
          id: 3, 
          ...
          imageUrl: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&h=300&fit=crop",
          description: "Small pothole on highway shoulder",
          coordinates: "40.7282° N, 73.7949° W",
          mapUrl: "https://www.google.com/maps?q=40.7282,-73.7949"
        }
      ],
      underRepair: [
        { 
          id: 4, 
          location: "First Street Plaza", 
          severity: "High", 
          ...
          imageUrl: "https://images.unsplash.com/photo-1616048056616-7c5d50c45ce3?w=500&h=300&fit=crop",
          description: "Major road repair in progress",
          coordinates: "40.7505° N, 73.9934° W",
          mapUrl: "https://www.google.com/maps?q=40.7505,-73.9934"
        },
        { 
          id: 5, 
          ...
          imageUrl: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&h=300&fit=crop",
          description: "Bridge surface repair ongoing",
          coordinates: "40.7614° N, 73.9776° W",
          mapUrl: "https://www.google.com/maps?q=40.7614,-73.9776"
        }
      ],
      finished: [
        { 
          ...
          duration: "3 days",
          reporter: "Park Maintenance",
          reportedDate: "2025-08-05",
          imageUrl: "https://images.unsplash.com/photo-1616048056616-7c5d50c45ce3?w=500&h=300&fit=crop",
          description: "Pothole repair completed successfully",
          coordinates: "40.7831° N, 73.9712° W",
          mapUrl: "https://www.google.com/maps?q=40.7831,-73.9712"
        },
        { 
          id: 7, 
          location: "School Zone Road", 
          severity: "High", 
          completedDate: "2025-08-05", 
          duration: "5 days",
          reporter: "School District",
          reportedDate: "2025-07-31",
          imageUrl: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&h=300&fit=crop",
          description: "Emergency repair completed before school start",
          coordinates: "40.7484° N, 73.9857° W",
          mapUrl: "https://www.google.com/maps?q=40.7484,-73.9857"
        },
        { 
          id: 8, 
          ...
          imageUrl: "https://images.unsplash.com/photo-1616048056616-7c5d50c45ce3?w=500&h=300&fit=crop",
          description: "Minor pothole fixed quickly",
          coordinates: "40.7580° N, 73.9855° W",
          mapUrl: "https://www.google.com/maps?q=40.7580,-73.9855"
        }
      ]
    };
                      ...
                      >
                        ...
                        {modalType === 'finished' && (
                          <>
                            ...
                            <td className="px-6 py-4">
                              <button 
                                onClick={() => viewImage(item.completionImageUrl || item.imageUrl)}
